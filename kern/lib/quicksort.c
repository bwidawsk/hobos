...
qsort(void *base, int64_t ndxl, int64_t ndxr, uint64_t elem_size, int(*compar)(const void *, const void *)) {
    ...
    int64_t pivot_ndx = ndxl + (ndxr - ndxl) / 2;
    int64_t new_ndx = partition(base, ndxl, ndxr, elem_size, compar, pivot_ndx);
